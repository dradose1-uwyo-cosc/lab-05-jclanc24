...
for i in range(len(max_temps)):
    if max_temps[i] > maxtemp:
        maxtemp = max_temps[i]
print(f"The highest high temperature in Laramie was {maxtemp}°F.")

for i in range(len(min_temps)):
    if min_temps[i] < mintemp:
        mintemp = min_temps[i]
print(f"The lowest low temperature in Laramie was {mintemp}°F.")

#Two loops used for ease of logic and to account for two lists having differing number of index positions.


# Given the below list
numbers = [-61, -76, 94, 21, 97, -4, 21, 56, -26, 9, 100, 56, -7, -32, 60, -68, -
25, 3, -10, -83, 63, 0, 13, -99, 87, -46, -88, -71, 4, -99, -15, -12, 72, -1, -20,
-90, 32, -36, -59, 83, 78, 52, 43, 55, 12, 16, -37, -5, -98, -53]
